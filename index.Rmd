...
- Some background knolwedge in [Pandoc Markdown](https://pandoc.org/MANUAL.html).

---

# About Me

- Blind person (one of my identities).

- Assistant professor at the UIUC iSchool + NCSA affiliate.

- RStudio DS education partner.

- Open-source contributor + R developer: {rmarkdown}, {shiny}, {bookdown}, {distill}, {rticles} ...

- Certified a11y professional.
